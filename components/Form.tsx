...
const Form = ({type, post, setPost, submitting, handleSubmit}: 
  ...
  return (  
      <section className='w-full max-w-full flex-start flex-col'>
          ...
          <p className='desc text-left max-w-md'>{type} and shate amazing prompts 
          with the world and let your imagination run wild with any AI-powered platform.</p>
          <form onSubmit={handleSubmit} className='mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism'>
            <label>
              ...
              prompt: e.target.value})} placeholder='Write your prompt here...'
            ...
            <label>
              ...
              tag: e.target.value})} placeholder='#tag'
